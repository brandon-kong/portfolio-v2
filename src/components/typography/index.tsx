...
const H1 = ({ className, children }: TypographyProps) => {
    return (
        <h1 className={cn("scroll-m-20 text-[32px] sidebar-shown:text-[40px] font-semibold leading-normal tracking-[-0.03em]", className)}>
            {children}
        </h1>
    );
};
...
const H2 = ({ className, children }: TypographyProps) => {
    return (
        <h2 className={cn("scroll-m-20 text-[26px] font-medium tracking-[-0.02em] first:mt-0", className)}>
            {children}
        </h2>
    );
};
...
const P = ({ className, children }: TypographyProps) => {
    return (
        <p className={cn("font-normal text-[18px] leading-relaxed", className)}>
            {children}
        </p>
    );
};
